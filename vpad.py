...
main_application.geometry('1200x800')
main_application.title('Taukir\'s Editor')
main_application.wm_iconbitmap('icon.ico')
# main_application.wm_iconbitmap('icon2/taukir.ico')
...
##font color chooser Functionality
...
def changed(event=None):
    ...
    if text_editor.edit_modified():
        ...
        # characters = len(text_editor.get(1.0, 'end-1c').replace(' ', ''))   ----for not counting spaces a character 😁
